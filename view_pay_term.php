...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <h1>View Payment Remarks History</h1><br>
                <!-- <div class="container"> -->
                <?php
...
if (isset($_POST['view_btn'])) {
    $id = $_POST['view_id'];
    $query = "SELECT * FROM remarks_history where remarks_id ='$id' && module='Payment_term'";
								// echo $query;
...
?>
                    <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <!-- <div class="form-group">
                            ...
                            <label for="exampleInputName"><?php echo $row['item']; ?></label>
                        </div>     -->
                        <div class="form-group">
