...
if (isset($_POST["buy_item_submit"])) {
    ...
    $quantity   = $_POST["quantity"];
        ...
        $addBuyerItem = "INSERT INTO `buyer_item`(`segment`, `buyer`, `product`, `customer`, `quantity`) VALUES ('$segment','$buyer','$product','$customer','$quantity')";
        $fire = mysqli_query($con, $addBuyerItem);
        if ($fire) {
