...
if (isset($_POST["supply_db_submit"])) {
    ...
    $agency   = $_POST["agency"];
        ...
        $addSupplierDb = "INSERT INTO `supplier_db`(`supplier_name`, `product_name`, `pharmacopia`, `credentials`, `agency`)
         VALUES ('$supplier_name','$product_name','$pharmacopia','$credentials','$agency')";
        $fire = mysqli_query($con, $addSupplierDb);
        if ($fire) {
                ...
                <div class="container">
                    ...
                    <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="product_name" class="form-control" aria-describedby="emailHelp" placeholder="Enter Product Name" required>

                        </div>
                        <div class="form-group">
                            <label for="exampleInputName">Pharmacopia</label>
                            <input type="text" name="pharmacopia" class="form-control" aria-describedby="emailHelp" placeholder="Enter Pharmacopia" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputName">Credentials</label>
                            <input type="text" name="credentials" class="form-control" aria-describedby="emailHelp" placeholder="Enter Credentials" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputName">Agency</label>
                            <input type="text" name="agency" class="form-control" aria-describedby="emailHelp" placeholder="Enter Agency" required>
                        </div>
