...
if (isset($_POST["dtl_supply_item_submit"])) {
    ...
    $price      = $_POST["price"];
        ...
        $addDtlSupplierItem = "INSERT INTO `dtl_supplier_item`(`segment`, `supplier`, `product`, `customer`, `quantity`, `price`) VALUES ('$segment','$supplier','$product','$customer','$quantity','$price')";
        $fire = mysqli_query($con, $addDtlSupplierItem);
        if ($fire) {
