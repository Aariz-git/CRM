...
if (isset($_POST["customer_submit"])) {
    ...
    $cnf       = $_POST["cnf"];
        ...
        $addCustomer = "INSERT INTO `remaining_the_mail`(`segment`,`customer`, `product`, `attribute`, `quantity`, `fob`, `cnf`) VALUES 
		('$segment','$customer','$product','$attribute ','$quantity','$fob',' $cnf')";
...
<head>
    ...
    <!-- Title Page-->
    <title>Add Remaining Mail</title>
            ...
            <div class="main-content">
                ...
                <div class="container">
                    ...
                    <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
                        <h1>Add Remaining Mail</h1><br>
                        <div class="form-group">
                            <label for="exampleInputName">Segment</label>
                            <input type="text" name="segment" class="form-control" aria-describedby="emailHelp" placeholder="Enter Name" required>

                        </div>
                        <div class="form-group">
                            <label for="exampleInputName">Customer</label>
                            <input type="text" name="customer" class="form-control" aria-describedby="emailHelp" placeholder="Enter Email" required>

                        </div>
                        <div class="form-group">
                            <label for="exampleInputName">Product</label>
                            <input type="text" name="product" class="form-control" aria-describedby="emailHelp" placeholder="Enter Contact Person" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputName">Attribute</label>
                            <input type="text" name="attribute" class="form-control" aria-describedby="emailHelp" placeholder="Enter Designation" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputName">Quantity</label>
                            <input type="text" name="quantity" class="form-control" aria-describedby="emailHelp" placeholder="Enter Company Address" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputName">FOB</label>
                            <input type="text" name="fob" class="form-control" aria-describedby="emailHelp" placeholder="Enter Company Telephone" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputName">CNF</label>
                            <input type="text" name="cnf" class="form-control" aria-describedby="emailHelp" placeholder="Enter Cell Number" required>
                        </div>
