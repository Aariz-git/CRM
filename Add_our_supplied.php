...
if (isset($_POST["our_supply_submit"])) {
    ...
    $quantity   = $_POST["quantity"];
        ...
        $addOurSupply = "INSERT INTO `our_supplied`(`segment`, `supplier`, `customer`, `product`, `quantity`) VALUES ('$segment','$supplier','$customer','$product','$quantity')";
        $fire = mysqli_query($con, $addOurSupply);
        if ($fire) {
...
<?php
    header('Location: Add_our_supplied.php');   
    }
                ...
                <div class="container">
                    ...
                    <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="segment" class="form-control" aria-describedby="emailHelp" placeholder="Enter Segment" required>
