...
$addasignmentQuery = "UPDATE supplier_item set segment='$segment',supplier='$supplier',product='$product',customer='$customer'
...
<body class="animsition">
 ...
 <?php
                            ...
                            if (isset($_POST['edit_btn'])) {
                                $id = $_POST['edit_id'];
                                $query = "SELECT * FROM supplier_item where id ='$id'";
//								echo $query;
                    ...
                    <form action="edit_supplier_item.php" method="POST" enctype="multipart/form-data">
