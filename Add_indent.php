...
if (isset($_POST["Indent_submit"])) {
    ...
    $addIndent = "INSERT INTO `indent_register`(`indent_no`, `buyer`, `item`, `quantity`, `price`, `value`, `hs_code`, `pay_term`, `shipment`, `invoice_no`, `po_no`, `indent_date`, `supplier`, `attribute`, `instance`, `uom`, `currency`, `ship_mode`, `payment_term`, `shipment_mode`, `date`, `exp_date`, `invoice_date`, `po_date`) 
    VALUES ('$indent_no','$buyer','$item','$quantity','$price','$value','$hs_code','$pay_term','$shipment','$invoice_no','$po_no','$indent_date','$supplier','$attribute','$instance','$uom','$currency','$ship_mode','$payment_term','$shipment_mode','$date','$exp_date','$invoice_date','$po_date')";
    $fire = mysqli_query($con, $addIndent);
    if ($fire) {
                ...
                <div class="container">
                    ...
                    <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="indent_no" class="form-control" aria-describedby="emailHelp" placeholder="Enter Indent Number" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="value" class="form-control" aria-describedby="emailHelp" placeholder="Enter Value" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputName">HS Code</label>
                            <input type="text" name="hs_code" class="form-control" aria-describedby="emailHelp" placeholder="Enter HS Code" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="shipment" class="form-control" aria-describedby="emailHelp" placeholder="Enter Shipment" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputName">Invoice Number</label>
                            <input type="text" name="invoice_no" class="form-control" aria-describedby="emailHelp" placeholder="Enter Invoice Number" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputName">PO Number</label>
                            <input type="text" name="po_no" class="form-control" aria-describedby="emailHelp" placeholder="Enter PO Number" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputName">Indent Date</label>
                            <input type="date" class="datepicker form-control" data-date-format="yyyy/mm/dd" name="indent_date" placeholder="Enter Indent Date" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="attribute" class="form-control" aria-describedby="emailHelp" placeholder="Enter Attribute" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputName">Instance</label>
                            <input type="text" name="instance" class="form-control" aria-describedby="emailHelp" placeholder="Enter Instance" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="ship_mode" class="form-control" aria-describedby="emailHelp" placeholder="Enter Shipment Mode" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputName">Payment Term</label>
                        ...
                        <div class="form-group">
                            <label for="exampleInputName">Shipment Mode</label>
                            <input type="text" name="shipment_mode" class="form-control" aria-describedby="emailHelp" placeholder="Enter Shipment Mode" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputName">Date</label>
                            <input type="date" class="datepicker form-control" data-date-format="yyyy/mm/dd" name="date" placeholder="Enter Date" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputName">Expiry Date</label>
                            <input type="date" class="datepicker form-control" data-date-format="yyyy/mm/dd" name="exp_date" placeholder="Enter Expiry Date" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputName">Invoice Date</label>
                            <input type="date" class="datepicker form-control" data-date-format="yyyy/mm/dd" name="invoice_date" placeholder="Enter Invoice Date" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputName">PO Date</label>
                            <input type="date" class="datepicker form-control" data-date-format="yyyy/mm/dd" name="po_date" placeholder="Enter PO Date" required>
                        </div>
