...
if (isset($_POST["dtl_supply_item_submit"])) {
...
$addasignmentQuery = "UPDATE dtl_supplier_item set segment='$segment',supplier='$supplier',product='$product',customer='$customer'
...
<?php
    header('Location: Add_dtl_supplier_item.php');   
    }
...
<head>
    ...
    <!-- Title Page-->
    <title>Add Detail of Supplier Item</title>
...
<body class="animsition">
 ...
 <?php
                            ...
                            if (isset($_POST['edit_btn'])) {
                                $id = $_POST['edit_id'];
                                $query = "SELECT * FROM dtl_supplier_item where id ='$id'";
//								echo $query;
                            ...
                            ?>
                    <form action="edit_dtl_supplier_item.php" method="POST" enctype="multipart/form-data">
                        <h1>Add Detail of Supplier Item</h1><br>
                        <div class="form-group">
						  <input type="hidden" name="edit_id" value="<?php echo $row['id']; ?>">
                            <label for="exampleInputName">Segment</label>
                            <select class="custom-select" name="segment">
                                <option value="Raw Material" <?=$row['segment'] == 'Raw Material' ? ' selected="selected"' : '';?>>Raw Material</option>
                                <option value="Packaging" <?=$row['segment'] == 'Packaging' ? ' selected="selected"' : '';?>>Packaging</option>
                                <option value="Machinary" <?=$row['segment'] == 'Machinary' ? ' selected="selected"' : '';?>>Machinary</option>
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit" name="dtl_supply_item_submit" class="btn btn-primary mt-1">Submit</button>
                    </form>
                    <?php
								}
							}
