...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <h1>View Quotation Remarks History</h1><br>
                <!-- <div class="container"> -->
                <?php
...
if (isset($_POST['view_btn'])) {
    $id = $_POST['view_id'];
    $query = "SELECT * FROM remarks_history where remarks_id ='$id' && module='Quotation'";
								// echo $query;
...
?>
                    <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <!-- <input type="text" name="customer" value="" class="form-control" aria-describedby="emailHelp" placeholder="Enter Customer" required> -->
                        </div>
