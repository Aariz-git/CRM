...
if (isset($_POST["customer_submit"])) {
    ...
    $check_query = mysqli_query($con, "Select * from customer where customer_email = '$c_email'");
...
?>
        ...
        $addCustomer = "INSERT INTO `customer`(`customer_name`,`customer_email`, `contact_person`, `designation`, `company_address`, `company_tel`, `cell_number`) VALUES ('$c_name','$c_email','$Contact_person','$Designation ','$Company_address','$Company_tel',' $Cell_number')";
        $fire = mysqli_query($con, $addCustomer);
        if ($fire) {
                ...
                <div class="container">
                    ...
                    <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="C_name" class="form-control" aria-describedby="emailHelp" placeholder="Enter Name" required>

                        </div>
                        <div class="form-group">
                            <label for="exampleInputName">Customer Email</label>
                            <input type="email" name="C_email" class="form-control" aria-describedby="emailHelp" placeholder="Enter Email" required>

                        </div>
                        <div class="form-group">
                            <label for="exampleInputName">Contact Person</label>
                            <input type="text" name="Contact_person" class="form-control" aria-describedby="emailHelp" placeholder="Enter Contact Person" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputName">Designation</label>
                            <input type="text" name="Designation" class="form-control" aria-describedby="emailHelp" placeholder="Enter Designation" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputName">Company Address</label>
                            <input type="text" name="Company_address" class="form-control" aria-describedby="emailHelp" placeholder="Enter Company Address" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputName">Company Telephone</label>
                            <input type="text" name="Company_tel" class="form-control" aria-describedby="emailHelp" placeholder="Enter Company Telephone" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputName">Cell Number</label>
                            <input type="text" name="Cell_number" class="form-control" aria-describedby="emailHelp" placeholder="Enter Cell Number" required>
                        </div>
